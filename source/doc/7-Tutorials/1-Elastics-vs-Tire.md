...
> Elastics allows you to reuse any fragment of any query into any other query {% see 2.3.2#query_fragment_reuse %}. You can even use chainable scopes to pure ruby reusability {% see 3 %}
