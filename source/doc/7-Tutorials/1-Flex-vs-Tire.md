...
It's also more powerful for experts, since it covers all the elasticsearch APIs {% see 2.2 %} and offers a lot of useful tools like index dumping and loading {% see 6 %}, a very advanced live-reindex feature {% see 4.6 %}, very detailed debugging info, high configurable logging, a self documentation tool, a lot of out of the box integrations, and a better documentation with some tutorial {% see 1.1 %}.
