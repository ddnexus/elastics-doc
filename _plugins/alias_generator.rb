  ...
  class AliasGenerator < Generator
    ...
    def process_pages
      @site.pages.each do |page|
        if page.data['alias_index']
          generate_aliases(page.destination(''), page.dir + '/index.html')
        end
    ...
    def alias_template(destination_path)
      ...
      <html>
      <head>
      <link rel="canonical" href="#{Helper.baseurl}#{destination_path}"/>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
      <meta http-equiv="refresh" content="0;url=#{Helper.baseurl}#{destination_path}" />
      </head>
      </html>
      EOF
    end
